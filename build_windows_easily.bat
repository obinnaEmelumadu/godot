...
:: Build 64-bit Godot
scons p=windows -j%threads% verbose=no tools=yes target=release_debug
scons p=windows -j%threads% verbose=no tools=no target=release
scons p=windows -j%threads% verbose=no tools=no target=release_debug
